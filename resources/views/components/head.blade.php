...
<link id="bootstrap-style" rel="stylesheet" type="text/css" href="{{ asset('assets/css/bootstrap.min.css') }}">

<!-- App Css (LIGHT default) -->
<link id="app-style" rel="stylesheet" type="text/css" href="{{ asset('assets/css/app.min.css') }}">

<!-- Icons (sekali aja) -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/icons.min.css') }}">

<!-- Vendor lain (DataTables, Select2, Toastr, SweetAlert, Datepicker, vmap) cukup 1x masing-masing -->
